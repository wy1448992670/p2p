...
@Entity
public class v_debt_transfer extends Model {
	...
	public enum Status {
		AUDITING("AUDITING", "待审核", 1), FUNDRAISE("FUNDRAISE", "转让中", 2), SUCCESS("SUCCESS", "成功的", 3), // 成功的：包括：还款中、已还款
		NOT_THROUGH("NOT_THROUGH", "未通过", 4), FLOW("FLOW", "失败的", 5); // 失败的：即流标
	...
	public enum AuditStatus {
		AUDITING("AUDITING", "未审核", 1), AUDIT_PASS("AUDIT_PASS", "初审通过", 2),
		AUDIT_NOT_PASS("AUDIT_NOT_PASS", "初审不通过", 3), RECHECK_PASS("RECHECK_PASS", "复审通过", 4),
