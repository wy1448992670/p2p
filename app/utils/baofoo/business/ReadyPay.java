...
public class ReadyPay{
	 ...
	 * @throws Exception
	 */
	public static String execute(String ProtocolNo, long userId, BigDecimal money) throws Exception {
		...
		DateArry.put("txn_amt", money.multiply(new BigDecimal(100)).setScale(0).toString());//交易金额 [单位：分  例：1元则提交100]，此处注意数据类型的转转，建议使用BigDecimal类弄进行转换为字串
